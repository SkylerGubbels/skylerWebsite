...
class TechnicalSkills extends Skills {
    ...
    render() { 
        ...
        <div>
            ...
            {Object.keys(text).map(key => this.createSkillCategory(text[key].title, text[key].text, "categoryTitle skillCategoryTitle whiteText", "text skillCategoryText whiteText", key))}
        </div>
        );
    }
}
